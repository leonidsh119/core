...
public class A5sPdpTest extends XacmlXmlPdpTest
{
    /**
     * Name of root directory that contains test resources for each test
     */
    public final static String TEST_RESOURCES_ROOT_DIRECTORY_LOCATION = "target/test-classes/a5s";
     ...
     */
    public A5sPdpTest(final String testDir)
    {
        super(testDir);
    }
